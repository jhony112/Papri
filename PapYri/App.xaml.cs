...
namespace PapYri
{
    ...
    sealed partial class App : Application
    {
        ...
        private Color _foreground = Color.FromArgb(255, 0, 70, 0);
        /// <summary>
        ...
        protected override async void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            if (rootFrame == null)
            {
                ...
                rootFrame.Background = new ImageBrush
                {
                    ...
                    ImageSource =
                        new BitmapImage { UriSource = new Uri("ms-appx:///Assets/bg3.jpg") }
                };
            ...
            if (rootFrame.Content == null)
            {
                ...
                // parameter
                rootFrame.Navigate(typeof(Landing), e.Arguments);
            }
...
var msg = Windows.Storage.ApplicationData.Current.RoamingStorageQuota;
